...
export const ShareButtons = ({ title }: ShareButtonsProps) => {
  ...
  return (
    <div className="share-section pt-12 md:pt-16">
      <h3 className="text-center text-xs uppercase tracking-wider text-gray-400 mb-8">공유</h3>
      <div className="share-buttons flex justify-center gap-4">
        <button
          onClick={() => shareUtils.twitter(currentUrl, title)}
          aria-label="Share on Twitter"
          className="p-4 hover:opacity-85 transition-smooth"
        >
